...
_vehicle addAction ["<t color='#FF0000'>" + "Sling Rope Attach" + "</t>","scripts\aw_sling\aw_sling_attach.sqf",[],21,true,true,"","(_this == driver _target) AND (count ((getPos _target) nearEntities [['Car','Motorcycle','Tank','ship','BWA3_Box_All'],5]) > 0) AND !(_target getVariable 'aw_sling_attached')"];
