...
_nearUnits = (getPos _helo) nearEntities [["Car","Motorcycle","Tank","Ship","BWA3_Box_All"],7];
...
_lightCant = _mediumCant + ["MRAP_02_base_F","MRAP_01_base_F","MRAP_03_base_F","Offroad_01_base_F","Boat_Armed_01_base_F","BWA3_Box_All"];
